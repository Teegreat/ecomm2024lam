          ...
          <ul className="flex items-center gap-3">
            {option.choices?.map((choice) => {
              ...
              return option.name === "Color" ? (
                ...
                >
                  {selected && (
                    <div className="absolute w-10 h-10 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
                  )}
                  {disabled && (
                    <div
                ...
                <li
                  key={choice.description}
                  className="ring-1 ring-tee text-tee rounded-md py-1 px-4 text-sm"
                  style={{
                    cursor: disabled ? "not-allowed" : "pointer",
